  ...
  return (
    <div className="w-full">
      <ToggleGroup
        ...
        items={[
          {
            content: <PlanContent type="arcade" name="Arcade" price={9} />,
            value: 'arcade',
          },
          {
            content: <PlanContent type="advanced" name="Advanced" price={12} />,
            value: 'advanced',
          },
          {
            content: <PlanContent type="pro" name="Pro" price={15} />,
            value: 'pro',
          },
        ]}
        type="single"
